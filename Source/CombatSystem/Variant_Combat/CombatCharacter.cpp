...
void ACombatCharacter::ComboAttackReleased()
{
	// route the input
	DoComboAttackEnd();
}
...
void ACombatCharacter::HeavyAttackReleased()
{
}
...
void ACombatCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(ComboAttackAction, ETriggerEvent::Completed, this, &ACombatCharacter::ComboAttackReleased);

		// Heavy Attack
		if (HeavyAttackAction != nullptr)
		{
			EnhancedInputComponent->BindAction(HeavyAttackAction, ETriggerEvent::Started, this, &ACombatCharacter::HeavyAttackPressed);
			EnhancedInputComponent->BindAction(HeavyAttackAction, ETriggerEvent::Completed, this, &ACombatCharacter::HeavyAttackReleased);
		}
